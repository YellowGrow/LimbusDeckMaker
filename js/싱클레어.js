...
registerCharacter({
    characterName: '싱클레어',
    defaultIcon: './기타/수감자_싱클레어.png',
    personalities: [
        {
            id: 'sinclair_001',
            name: 'LCB 수감자',
            season: 'normal',
            image: './수감자/인격/싱클레어/LCB_수감자/프로필.png',
            tier: '1',
            skills: ['gloom', 'gloom', 'gloom', 'envy', 'envy', 'sloth'],
            defense: { type: 'guard', sin: 'gloom' },
            details: {
                fullImage: './수감자/인격/싱클레어/LCB_수감자/일러스트.png',
                skillIcons: [
                    './수감자/인격/싱클레어/LCB_수감자/1스킬.png', 
                    './수감자/인격/싱클레어/LCB_수감자/2스킬.png', 
                    './수감자/인격/싱클레어/LCB_수감자/3스킬.png', 
                    './수감자/인격/싱클레어/LCB_수감자/수비스킬.png'
                ],
        ...
        },
        {
            ...
            season: 'normal',
            tier: '2',
            image: './수감자/인격/싱클레어/남부_세븐_협회_6과/프로필.png',
            skills: ['gloom', 'gloom', 'gloom', 'gluttony', 'gluttony', 'sloth'],
            defense: { type: 'guard', sin: 'gluttony' },
            details: {
                fullImage: './수감자/인격/싱클레어/남부_세븐_협회_6과/일러스트.png',
                skillIcons: [
                    './수감자/인격/싱클레어/남부_세븐_협회_6과/1스킬.png', 
                    './수감자/인격/싱클레어/남부_세븐_협회_6과/2스킬.png', 
                    './수감자/인격/싱클레어/남부_세븐_협회_6과/3스킬.png', 
                    './수감자/인격/싱클레어/남부_세븐_협회_6과/수비스킬.png'
                ],
        ...
        },
        {
            ...
            season: 'normal',
            tier: '3',
            image: './수감자/인격/싱클레어/검계_살수/프로필.png',
            skills: ['pride', 'pride', 'pride', 'wrath', 'wrath', 'envy'],
            defense: { type: 'counter', sin: 'pride' },
            details: {
                fullImage: './수감자/인격/싱클레어/검계_살수/일러스트.png',
                skillIcons: [
                    './수감자/인격/싱클레어/검계_살수/1스킬.png', 
                    './수감자/인격/싱클레어/검계_살수/2스킬.png', 
                    './수감자/인격/싱클레어/검계_살수/3스킬.png', 
                    './수감자/인격/싱클레어/검계_살수/수비스킬.png'
                ],
        ...
        },
        {
            ...
            season: 2,
            tier: '3',
            image: './수감자/인격/싱클레어/개화_E.G.O_동백/프로필.png',
            skills: ['gluttony', 'gluttony', 'gluttony', 'sloth', 'sloth', 'pride'],
            defense: { type: 'evade', sin: 'sloth' },
            details: {
                fullImage: './수감자/인격/싱클레어/개화_E.G.O_동백/일러스트.png',
                skillIcons: [
                    './수감자/인격/싱클레어/개화_E.G.O_동백/1스킬.png', 
                    './수감자/인격/싱클레어/개화_E.G.O_동백/2스킬.png', 
                    './수감자/인격/싱클레어/개화_E.G.O_동백/3스킬.png', 
                    './수감자/인격/싱클레어/개화_E.G.O_동백/수비스킬.png'
                ],
                ...
                supportPassives: [
                    {
                        ...
                        condition: 'X3 공명',
                        name: '알싸한 봄바람',
                        effect: '정신력이 가장 낮은 아군 1명이 2명 싱클레어을 공격할 때 피해량 +10%'
                    }
                ],
                keywords: ['진동', '침잠']
            }
        },
        {
            ...
            season: 2,
            tier: '2',
            image: './수감자/인격/싱클레어/어금니_사무소_해결사/프로필.png',
            skills: ['lust', 'lust', 'lust', 'sloth', 'sloth', 'wrath'],
            defense: { type: 'guard', sin: 'sloth' },
            details: {
                fullImage: './수감자/인격/싱클레어/어금니_사무소_해결사/일러스트.png',
                skillIcons: [
                    './수감자/인격/싱클레어/어금니_사무소_해결사/1스킬.png', 
                    './수감자/인격/싱클레어/어금니_사무소_해결사/2스킬.png', 
                    './수감자/인격/싱클레어/어금니_사무소_해결사/3스킬.png', 
                    './수감자/인격/싱클레어/어금니_사무소_해결사/수비스킬.png'
                ],
        ...
        },
        {
            ...
            season: 'normal',
            tier: '3',
            image: './수감자/인격/싱클레어/W사_3등급_정리_요원/프로필.png',
            skills: ['sloth', 'sloth', 'sloth', 'gluttony', 'gluttony', 'gloom'],
            defense: { type: 'evade', sin: 'gloom' },
            details: {
                fullImage: './수감자/인격/싱클레어/W사_3등급_정리_요원/일러스트.png',
                skillIcons: [
                    './수감자/인격/싱클레어/W사_3등급_정리_요원/1스킬.png', 
                    './수감자/인격/싱클레어/W사_3등급_정리_요원/2스킬.png', 
                    './수감자/인격/싱클레어/W사_3등급_정리_요원/3스킬.png', 
                    './수감자/인격/싱클레어/W사_3등급_정리_요원/수비스킬.png'
                ],
        ...
        },
        {
            ...
            season: 3,
            tier: '2',
            image: './수감자/인격/싱클레어/피쿼드호_일등_항해사/프로필.png',
            skills: ['pride', 'pride', 'pride', 'envy', 'envy', 'gluttony'],
            defense: { type: 'evade', sin: 'pride' },
            details: {
                fullImage: './수감자/인격/싱클레어/피쿼드호_일등_항해사/일러스트.png',
                skillIcons: [
                    './수감자/인격/싱클레어/피쿼드호_일등_항해사/1스킬.png', 
                    './수감자/인격/싱클레어/피쿼드호_일등_항해사/2스킬.png', 
                    './수감자/인격/싱클레어/피쿼드호_일등_항해사/3스킬.png', 
                    './수감자/인격/싱클레어/피쿼드호_일등_항해사/수비스킬.png'
                ],
        ...
        },
        {
            ...
            season: 'normal',
            tier: '2',
            image: './수감자/인격/싱클레어/남부_디에치_협회_4과/프로필.png',
            skills: ['gluttony', 'gluttony', 'gluttony', 'lust', 'lust', 'sloth'],
            defense: { type: 'guard', sin: 'sloth' },
            details: {
                fullImage: './수감자/인격/싱클레어/남부_디에치_협회_4과/일러스트.png',
                skillIcons: [
                    './수감자/인격/싱클레어/남부_디에치_협회_4과/1스킬.png', 
                    './수감자/인격/싱클레어/남부_디에치_협회_4과/2스킬.png', 
                    './수감자/인격/싱클레어/남부_디에치_협회_4과/3스킬.png', 
                    './수감자/인격/싱클레어/남부_디에치_협회_4과/수비스킬.png'
                ],
                skillTypes: ['pierce', 'blunt', 'blunt'],
                passives: [
                    {
        ...
        },
        {
            ...
            season: 'normal',
            tier: '3',
            image: './수감자/인격/싱클레어/약지_점묘파_스튜던트/프로필.png',
            skills: ['gloom', 'gloom', 'gloom', 'lust', 'lust', 'sloth'],
            defense: { type: 'guard', sin: 'lust' },
            details: {
                fullImage: './수감자/인격/싱클레어/약지_점묘파_스튜던트/일러스트.png',
                skillIcons: [
                    './수감자/인격/싱클레어/약지_점묘파_스튜던트/1스킬.png', 
                    './수감자/인격/싱클레어/약지_점묘파_스튜던트/2스킬.png', 
                    './수감자/인격/싱클레어/약지_점묘파_스튜던트/3스킬.png', 
                    './수감자/인격/싱클레어/약지_점묘파_스튜던트/수비스킬.png'
                ],
                skillTypes: ['pierce', 'pierce', 'pierce'],
                passives: [
                    {
        ...
        },
        {
            ...
            season: 'walpurgis',
            tier: '3',
            image: './수감자/인격/싱클레어/로보토미_E.G.O_엄숙한_애도/프로필.png',
            skills: ['pride', 'pride', 'pride', 'gloom', 'gloom', 'sloth'],
            defense: { type: 'guard', sin: 'gloom' },
            details: {
                fullImage: './수감자/인격/싱클레어/로보토미_E.G.O_엄숙한_애도/일러스트.png',
                skillIcons: [
                    './수감자/인격/싱클레어/로보토미_E.G.O_엄숙한_애도/1스킬.png', 
                    './수감자/인격/싱클레어/로보토미_E.G.O_엄숙한_애도/2스킬.png', 
                    './수감자/인격/싱클레어/로보토미_E.G.O_엄숙한_애도/3스킬.png', 
                    './수감자/인격/싱클레어/로보토미_E.G.O_엄숙한_애도/수비스킬.png'
                ],
                skillTypes: ['pierce', 'pierce', 'pierce'],
                passives: [
                    {
        ...
        },
        {
            ...
            season: 5,
            tier: '2',
            image: './수감자/인격/싱클레어/LCE_E.G.O_초롱/프로필.png',
            skills: ['sloth', 'sloth', 'sloth', 'envy', 'envy', 'gluttony'],
            defense: { type: 'counter', sin: 'gluttony' },
            details: {
                fullImage: './수감자/인격/싱클레어/LCE_E.G.O_초롱/일러스트.png',
                skillIcons: [
                    './수감자/인격/싱클레어/LCE_E.G.O_초롱/1스킬.png', 
                    './수감자/인격/싱클레어/LCE_E.G.O_초롱/2스킬.png', 
                    './수감자/인격/싱클레어/LCE_E.G.O_초롱/3스킬.png', 
                    './수감자/인격/싱클레어/LCE_E.G.O_초롱/수비스킬.png'
                ],
        ...
        },
        {
            ...
            season: 'normal',
            tier: '3',
            image: './수감자/인격/싱클레어/남부_리우_협회_3과/프로필.png',
            skills: ['sloth', 'sloth', 'sloth', 'wrath', 'wrath', 'envy'],
            defense: { type: 'counter', sin: 'wrath' },
            details: {
                fullImage: './수감자/인격/싱클레어/남부_리우_협회_3과/일러스트.png',
                skillIcons: [
                    './수감자/인격/싱클레어/남부_리우_협회_3과/1스킬.png', 
                    './수감자/인격/싱클레어/남부_리우_협회_3과/2스킬.png', 
                    './수감자/인격/싱클레어/남부_리우_협회_3과/3스킬.png', 
                    './수감자/인격/싱클레어/남부_리우_협회_3과/수비스킬.png'
                ],
                skillTypes: ['slash', 'slash', 'slash', 'slash'],
                passives: [
                    {
        ...
        },
        {
            ...
            season: 6,
            tier: '3',
            image: './수감자/인격/싱클레어/N사_E.G.O_흉탄/프로필.png',
            skills: ['wrath', 'wrath', 'wrath', 'lust', 'lust', 'pride'],
            defense: { type: 'counter', sin: 'pride' },
            details: {
                fullImage: './수감자/인격/싱클레어/N사_E.G.O_흉탄/일러스트.png',
                skillIcons: [
                    './수감자/인격/싱클레어/N사_E.G.O_흉탄/1스킬.png', 
                    './수감자/인격/싱클레어/N사_E.G.O_흉탄/2스킬.png', 
                    './수감자/인격/싱클레어/N사_E.G.O_흉탄/3스킬.png', 
                    './수감자/인격/싱클레어/N사_E.G.O_흉탄/수비스킬.png'
                ],
        ...
        },
        {
            ...
            season: 6,
            tier: '3',
            image: './수감자/인격/싱클레어/흑수_오_필두/프로필.png',
            skills: ['sloth', 'sloth', 'sloth', 'envy', 'envy', 'gluttony'],
            defense: { type: 'guard', sin: 'gluttony' },
            details: {
                fullImage: './수감자/인격/싱클레어/흑수_오_필두/일러스트.png',
                skillIcons: [
                    './수감자/인격/싱클레어/흑수_오_필두/1스킬.png', 
                    './수감자/인격/싱클레어/흑수_오_필두/2스킬.png', 
                    './수감자/인격/싱클레어/흑수_오_필두/3스킬.png', 
                    './수감자/인격/싱클레어/흑수_오_필두/수비스킬.png'
                ],
        ...
        [ 
            {
                ...
                name:'오감도',
                season: 'normal',
                image:'./수감자/에고/싱클레어/오감도/일러스트.png',
                slotImage:'./수감자/에고/싱클레어/오감도/프로필.png',
                egoDetails:{
                    fullImage:'./수감자/에고/싱클레어/오감도/일러스트.png',
            ...
            },
            {
                ...
                name:'지난 날',
                season: '4',
                image:'./수감자/에고/싱클레어/지난_날/일러스트.png',
                slotImage:'./수감자/에고/싱클레어/지난_날/프로필.png',
                egoDetails:{
                    fullImage:'./수감자/에고/싱클레어/지난_날/일러스트.png',
                    cost:['sloth','sloth','sloth','gloom','gloom','gloom'],
                    passive:{ name:'조각난 어제', effect:'대상의 침잠 위력이 6 싱클레어이면, 합 위력 +1\n대상의 침잠 횟수가 4 싱클레어이면, 합 위력 +1'},
                    keywords:['침잠'],
                    awakening:{
                        sanityCost:15,
                        attackType:'pierce',
                        ...
                        coins:[
                            ...
                            { index:1, effect:'[적중시] 대상에게 침잠이 6 싱클레어이면 다음 턴에 속박 2 부여' }
                        ]
                    },
                    corrosion:{
                        sanityCost:15,
                        ...
                        coinFaces:['tail'],
                        coins:[
                            { noIndex:true, effect:'[피아식별불가]\n무작위 대상 공격\n[공격 시작 전] 우울 공명 수가 3 싱클레어이면 공격 가중치 +1\n[공격 시작 전] 우울 공명 수가 5 싱클레어이면 공격 가중치 +1' },
                            { index:1, effect:'[적중시] 침잠 2 부여. 다음 턴에 속박 2 부여\n[적중시] 대상의 침잠이 6 싱클레어이면 다음 턴에 속박 2 부여' }
                        ]
                    }
                }
            }
        ...
        [
            {
                ...
                name:'4번째 성냥불',
                season: '1',
                image:'./수감자/에고/싱클레어/4번째_성냥불/일러스트.png',
                slotImage:'./수감자/에고/싱클레어/4번째_성냥불/프로필.png',
                egoDetails:{
                    fullImage:'./수감자/에고/싱클레어/4번째_성냥불/일러스트.png',
            ...
            },
            {
                ...
                name:'소망석',
                season: 'normal',
                image:'./수감자/에고/싱클레어/소망석/일러스트.png',
                slotImage:'./수감자/에고/싱클레어/소망석/프로필.png',
                egoDetails:{
                    fullImage:'./수감자/에고/싱클레어/소망석/일러스트.png',
        ...
        [
            {
                ...
                name:'차원찢개',
                season: 'normal',
                image:'./수감자/에고/싱클레어/차원찢개/일러스트.png',
                slotImage:'./수감자/에고/싱클레어/차원찢개/프로필.png',
                egoDetails:{
                    fullImage:'./수감자/에고/싱클레어/차원찢개/일러스트.png',
            ...
            },
            {
                ...
                name:'흉탄',
                season: '5',
                image:'./수감자/에고/싱클레어/흉탄/일러스트.png',
                slotImage:'./수감자/에고/싱클레어/흉탄/프로필.png',
                egoDetails:{
                    fullImage:'./수감자/에고/싱클레어/흉탄/일러스트.png',
        ...
        [
            {
                ...
                name:'여우비',
                season: '2',
                image:'./수감자/에고/싱클레어/여우비/일러스트.png',
                slotImage:'./수감자/에고/싱클레어/여우비/프로필.png',
                egoDetails:{
                    fullImage:'./수감자/에고/싱클레어/여우비/일러스트.png',
